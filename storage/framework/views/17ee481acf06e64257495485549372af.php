...
<!-- Flash message for post creation -->
    ...
    <?php endif; ?> <!-- __ENDBLOCK__ -->
        ...
        <div class="mb-6">
            <a wire:navigate href="<?php echo e(route('quiz.create')); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.search-box','data' => ['placeHolder' => 'quizzes']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['placeHolder' => 'quizzes']); ?>
...
<?php endif; ?>
            ...
            <ul class="divide-y divide-gray-200 dark:divide-gray-700">
                 <!-- __BLOCK__ --><?php $__currentLoopData = $quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="py-6">
                    <div class="flex justify-between">
                        <!-- Thread Title -->
                        <a href="<?php echo e(route('quiz.single', ['id' => $quiz->id])); ?>"
                            class="text-xl text-gray-900 dark:text-gray-100 hover:underline"><?php echo e($quiz->title); ?></a>
                        <span class="text-sm dark:text-gray-500"><?php echo e($quiz->created_at->diffForHumans()); ?></span>
                    </div>


                    <!-- Thread Details -->
                    <div class="mt-2 flex justify-between items-center text-sm text-gray-600 dark:text-gray-400">
                        <span class="capitalize">By: <?php echo e($quiz->user->name); ?></span>
                        <p class="gap-2 flex"><span><?php echo e($quiz->likes_count); ?> likes
                    ...
                    <p class="mt-4 text-gray-700 dark:text-gray-300">
                       <?php echo e(Str::limit( $quiz->body,100)); ?>
...
<?php /**PATH C:\Users\israel\Desktop\scholar-hub\resources\views/livewire/quiz/quizzes.blade.php ENDPATH**/ ?>