 ...
 <form class="md:w-1/3 flex justify-evenly gap-1 relative md:mb-3 ml-auto md:mr-1 ">
     ...
     <img wire:loading.delay.long wire:target="search" class="h-8 w-8 my-auto absolute top-1 right-0" src="{{ asset('svg/spinner-2.svg') }}" />
 </form>
